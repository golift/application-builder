...
# ----
#   curl -s https://raw.githubusercontent.com/this/repo/master/scripts/install.sh | sudo bash
#   wget -qO- https://raw.githubusercontent.com/this/repo/master/scripts/install.sh | sudo bash
# ----
#
...
BREW=golift/mugs/application-builder
